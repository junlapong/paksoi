...
const center = { lat: 13.804732, lng: 100.489412 };

const stations = [
  { position: { lat: 13.80575, lng: 100.489518 }, title: 'พลสเต็ก' },
  { position: { lat: 13.805869, lng: 100.48906 }, title: 'ปลาเผาผักไฮโดร' },
  { position: { lat: 13.807676, lng: 100.487753 }, title: 'ก๋วยเตี๋ยวเขย่าเส้น' },
  { position: { lat: 13.805496, lng: 100.488562 }, title: 'อาหารตามสั่งป้าส่ง' },
  { position: { lat: 13.804985, lng: 100.490929 }, title: 'ข้าวกล่องกุ๊กกิ๊ก' }
];
...
function encapsulateStyles(node) {
	setAttribute(node, "svelte-2229876945", "");
}
